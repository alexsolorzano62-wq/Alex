...
export const ETIQUETAS: { clave: string; descripcion: string }[] = [
  ...
  { clave: "cuotas_atrasadas", descripcion: "Cuántas cuotas se le pasaron" },
  { clave: "monto_atrasado", descripcion: "Lo que suman las cuotas atrasadas" },
...
export function variablesDePrestamo(
  ...
  return {
    ...
    cuotas_atrasadas: datos.cuotasAtrasadas > 0 ? String(datos.cuotasAtrasadas) : "",
    monto_atrasado: datos.cuotasAtrasadas > 0 ? plata(datos.montoAtrasado) : "",
