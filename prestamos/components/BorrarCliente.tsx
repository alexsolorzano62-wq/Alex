...
export default function BorrarCliente({
  ...
  return (
    <details className="mt-8 rounded-2xl border border-slate-200 bg-white">
      ...
      <form action={accion} className="border-t border-slate-100 px-4 py-4">
        ...
        <label className="mt-3 block">
          ...
          <input
            ...
            autoComplete="off"
            placeholder={nombre}
            className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-base outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100"
          />
        </label>
        ...
        <button
          type="submit"
          disabled={enviando}
          className="mt-3 w-full rounded-xl border border-red-300 px-4 py-2.5 text-sm font-semibold text-red-600 active:bg-red-50 disabled:opacity-60"
        >
